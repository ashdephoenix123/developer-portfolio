  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3">
        <div className="w-9 h-9 rounded-full bg-[#1a1a2e] border border-border flex items-center justify-center text-xs font-medium text-foreground flex-shrink-0 font-mono">
          AS
        </div>
