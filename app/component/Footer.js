  ...
  return (
    <div className="border border-border bg-card px-4 py-4 hover:bg-secondary/30 transition-colors cursor-pointer">
      ...
      <div className="flex gap-3">
        <div className="w-8 h-8 rounded-full bg-[#1a1a2e] border border-border flex items-center justify-center text-xs font-medium text-foreground flex-shrink-0 font-mono">
          AS
        </div>
...
const Footer = () => {
  ...
  return (
    <section id="contact" className="border-t border-border bg-card px-6 lg:px-24 font-sans">
      <div className="max-w-6xl mx-auto py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-16 mb-20 items-start">
          <FadeIn>
            ...
            {/* Email strip */}
            <div className="inline-flex flex-wrap sm:flex-nowrap items-center border border-border divide-y sm:divide-y-0 sm:divide-x divide-border mb-8 w-full sm:w-auto bg-background/50">
              <span
