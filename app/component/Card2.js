...
const Card = () => {
    ...
    return (
        <div className='flex bg-gray-200 text-black rounded my-2 dark:bg-gray-600 dark:text-zinc-300 overflow-hidden max-[716px]:block'>
            <Image src={'/jsimg2.png'} width={200} height={200} className='object-contain h-48 w-fit max-[716px]:mx-auto max-[716px]:w-full max-[716px]:object-cover max-[716px]:h-72 max-[716px]:object-bottom' alt="jsimg" />
