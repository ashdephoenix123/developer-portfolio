          ...
          <div className="slider">
            <div className="slide-track">
              ...
              <div className="slide relative">
                ...
                <div className="projBack">
                  <Link href={'https://akashsarki-projects.vercel.app/'} target="_blank" className="btn-outline absolute top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 flex items-center">VISIT <BsArrowUpRight className="ml-1" /></Link>
                </div>
