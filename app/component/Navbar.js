                ...
                toggle && <>
                    <div className='absolute w-full h-fit bg1 z-10' ref={toggleref}>
                        <ul>
                            ...
                            <li onClick={() => { setToggle(prev => !prev) }} className='cursor-pointer dark:bg-gray-700 dark:hover:bg-slate-800 dark:border-b-slate-500 hover:bg-zinc-200 border-b'><Link href={'/courses'} className='p-4 block'><span className='w-fit inline-block text-sm tracking-wide mr-1.5'>Courses</span></Link></li>
                        </ul>
                    </div>
                </>
            }
