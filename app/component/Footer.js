  ...
  return (
    <footer className="py-8 footer">
      <div className="container2 fontsm">
        <div className="flex items-center mb-2 w-fit max-[677px]:mx-auto">
          <IoMdMail className="mr-2" size={20} />
          akashsarki24@gmail.com
        </div>
        <div className="flex items-center mb-2 w-fit max-[677px]:mx-auto">
          <BsFillTelephoneFill className="mr-2" size={20} />
          +91 9883475729
        </div>
        <Link
          className="flex items-center mb-4 hover:underline w-fit max-[677px]:mx-auto"
          target="_blank"
          href={
            "https://www.google.com/maps/place/Champasari+Rd,+Siliguri,+West+Bengal+734003/@26.7518566,88.4144492,17z/data=!3m1!4b1!4m6!3m5!1s0x39e440dc036f43e7:0xc38e5c4edbd49084!8m2!3d26.7518566!4d88.4170241!16s%2Fg%2F1tk9p589?entry=ttu"
          }
        >
      ...
      <div className="container2 h-[0.2px] bg-gray-500"></div>
