    ...
    return (
        <footer className='py-8 dark:bg-slate-950 dark:text-gray-400'>
            <div className='container2 fontsm'>
                <div className='flex items-center mb-2 w-fit'><IoMdMail className='mr-2' size={20} />akashsarki24@gmail.com</div>
                <div className='flex items-center mb-2 w-fit'><BsFillTelephoneFill className='mr-2' size={20} />9883475729</div>
